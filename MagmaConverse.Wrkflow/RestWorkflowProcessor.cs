...
{
    internal interface IRestWorkflowProcessor
    {
        ISBSForm Form { get; }
    ...
    internal class RestWorkflowProcessor : IRestWorkflowProcessor
    {
        ...
        protected bool IsMockRest { get; private set; }
        ...
        {
            /*
                "workflow": "rest://localhost:8089/MagmaConverse/form/${field:RepeaterGroupForm.Id}/employee/add",
                "properties": {
                    "method": "post",
